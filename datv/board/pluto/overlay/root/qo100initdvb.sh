...
$(mosquitto_pub -t $cmd_root/tx/gain -m -5)
$(mosquitto_pub -t $cmd_root/tx/mute -m 0)

$(mosquitto_pub -t $cmd_root/tx/frequency -m 2403.75e6)
$(mosquitto_pub -t $cmd_root/tx/dvbs2/sr -m 250000)
...
$(mosquitto_pub -t $cmd_root/tx/dvbs2/fec -m 1/2)
...
$(mosquitto_pub -t $cmd_root/ip/iptables -m "-iptables -A FORWARD -p udp -o gse0 -s 44.0.0.0/24 -j DROP")
sleep 0.1
